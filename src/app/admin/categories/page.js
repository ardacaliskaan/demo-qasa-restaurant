...
export default function CategoriesAdminPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = apiPath('/api/admin/categories') // ✅ apiPath eklendi
  ...
  const handleDelete = async (category) => {
    ...
    try {
      const response = await fetch(apiPath(`/api/admin/categories?id=${category.id}`), { // ✅ apiPath eklendi
        method: 'DELETE'
      })
